...
LABEL_DIR = Path("local/data/dataset_yolo_counting/labels/test")

OUTPUT_DIR = Path("local/outputs/ml_evaluation")
PREDICTIONS_CSV = OUTPUT_DIR / "yolo_test_predictions.csv"
METRICS_CSV = OUTPUT_DIR / "yolo_test_metrics.csv"
TNTC_CONFUSION_CSV = OUTPUT_DIR / "yolo_test_tntc_confusion_matrix.csv"
