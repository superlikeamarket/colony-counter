...
PREDICTIONS_CSV = OUTPUT_DIR / "yolov8s_grid_predictions.csv"
METRICS_CSV = OUTPUT_DIR / "yolov8s_grid_metrics.csv"

CONF_THRESHOLDS = [0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45]
IOU_THRESHOLDS = [0.4, 0.5, 0.6, 0.7, 0.8]
IMAGE_SIZES = [640, 768, 896, 1024, 1280]
